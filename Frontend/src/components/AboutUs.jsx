...
const AboutUs = () => {
  return (
    <div className="bg-orange-200 text-orange-900">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              />
              <h4 className="text-xl font-bold">Tanavi Kolekar</h4>
              <p>Founder & CEO</p>
              <p className="text-sm mt-2">
                With 15+ years in the industry, Tanavi leads our team with passion and expertise.
              </p>
            </div>
            {/* Team Member 2 */}
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full mb-4"
              />
              <h4 className="text-xl font-bold">Jaydatta Shinde</h4>
      ...
      {/* Footer */}
      <footer className="bg-orange-200 py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm">&copy; 2025 Local Services. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
